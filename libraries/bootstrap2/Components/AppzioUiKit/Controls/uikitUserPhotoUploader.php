            ...
            if (isset($vars['profilepic']) AND $vars['profilepic']) {
                $col[] = $this->getComponentImage($vars['profilepic'],
                    ['priority' => '9',
                        ...
                        'imgheight' => '400',
                        'onclick' => $onclick,
                        'variable' => 'profilepic'], ['width' => '100', 'crop' => 'round']);
            } else {
                $col[] = $this->getComponentImage('uikit_photo_upload_blue.png',
                    ['priority' => '9',
                        'onclick' => $onclick,
                        'variable' => 'profilepic',
                    ], ['width' => '100', 'crop' => 'round']);
            }
        ...
        if (isset($vars[$varname]) AND $vars[$varname]) {
            return $this->getComponentImage($vars[$varname],
                ['priority' => '9',
                    ...
                    'format' => 'jpg',
                    'imgcrop' => 'yes',
                    'onclick' => $onclick, 'variable' => $varname], [
                    'width' => $width, 'crop' => 'round', 'margin' => '0 0 0 10']);
        } else {
            return $this->getComponentImage('uikit_photo_upload_blue.png',
                ['priority' => '9',
                    'onclick' => $onclick, 'variable' => $varname], ['width' => $width, 'crop' => 'round', 'margin' => '0 0 0 10']);
        }
        ...
        if (isset($vars[$varname]) AND $vars[$varname]) {
            ...
            return $this->getComponentImage('uikit_photo_upload_blue.png',
                ['priority' => '9',
                    ...
                    'imgcrop' => 'yes',
                    'onclick' => $onclick,
                    'variable' => $varname], ['width' => $width, 'crop' => 'round', 'margin' => '0 0 0 10']);
        }
    }
