...
trait Onclick
{
    ...
    public function getOnclickLogout()
    {
        $obj = new \StdClass;
        $obj->action = 'logout';
        //$obj->variables = \Aegame::$logout_vars;
        return $obj;
    }
     ...
     * @return \StdClass
     */
    public function getOnclickDoorflowAuthenticate(array $parameters = array())
    {
        $obj = new \StdClass;
        $obj->action = 'doorflow-authenticate';
        $obj = $this->attachParameters($obj, $parameters);
        return $obj;
    }
     ...
     * @return \StdClass
     */
    public function getOnclickDoorflowVerify($parameters = array())
    {
        $obj = new \StdClass;
        $obj->action = 'doorflow-verify';
        $obj = $this->attachParameters($obj, $parameters);
        return $obj;
    }

    public function getOnclickDoorflowUnlock($doorid,$parameters = array())
    {
        $obj = new \StdClass;
        $obj->action = 'doorflow-unlock';
        $obj->doorid = $doorid;
        $obj = $this->attachParameters($obj, $parameters);
        return $obj;
    }
    ...
    public function getOnclickSetVariables(array $variables, $clickparameters = array())
    {
        ...
        foreach ($variables as $var => $value) {
            if($this->model->getVariableId($var)){
                $var = $this->model->getVariableId($var);
            }
     ...
     * @return \stdClass
     */
    public function getOnclickCompleteAction(array $parameters=[])
    {
        $obj = new \StdClass;
     ...
     * @param string $asset_name -- as defined in the assetlist OR url. Note: no sanity checking here.
     * @return \stdClass
     */
    public function getOnclickPlaySound(string $asset_name)
    {
        /** @var BootstrapView $this */

        $obj = new \stdClass();
        $obj->action = 'play-sound';
        $obj->action_config = $asset_name;
        return $obj;
    }
    ...
    */
     ...
     * @return \stdClass
     */
    public function getOnclickStartTimer($id,$parameters = array())
    {
        /** @var BootstrapView $this */

        $obj = new \stdClass();
        $obj->action = 'start-timer';
        $obj->timer_id = $id;
        $obj = $this->attachParameters($obj, $parameters);
        return $obj;
    }
     ...
     * @return \stdClass
     */
    public function getOnclickPauseTimer($id,$parameters = array())
    {
        /** @var BootstrapView $this */

        $obj = new \stdClass();
        $obj->action = 'pause-timer';
        $obj->timer_id = $id;
        $obj = $this->attachParameters($obj, $parameters);
        return $obj;
    }
     ...
     * @return \stdClass
     */
    public function getOnclickStopTimer($id,$parameters = array())
    {
        /** @var BootstrapView $this */

        $obj = new \stdClass();
        $obj->action = 'stop-timer';
        $obj->timer_id = $id;
        $obj = $this->attachParameters($obj, $parameters);
        return $obj;
    }
