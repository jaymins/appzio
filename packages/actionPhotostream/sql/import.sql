CREATE TABLE IF NOT EXISTS `ae_ext_photostream` (
...
--
ALTER TABLE  `ae_ext_photostream` ADD FOREIGN KEY (  `playtask_id` ) REFERENCES  `ae_game_play_action` (
  `id`
) ON DELETE CASCADE ON UPDATE NO ACTION ;


CREATE TABLE IF NOT EXISTS `ae_ext_photostream_post` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
('Photostream', 'comments.png', 'photostream', 1, '<p></p><p>Create a shared photostream with a possibility of sending individual photos to a predefined address.</p>\r\n', '0.1', '', 'HTML 5', 1, 1, '', '', 0, 0, 1, 1);
