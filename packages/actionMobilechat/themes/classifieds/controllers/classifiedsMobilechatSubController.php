...
class classifiedsMobilechatSubController extends MobilechatController {
    ...
    public function getChatDivs() {
        return $this->registerProductDiv( 'buy-send-media', 'send-icon-fancy.png', '{#attach_photos#}', '{#attach_photos_for_your_chat#} {#valid_for_30_days#}', 'attach_photos.01', 'attach_photos.001', true );
    }
