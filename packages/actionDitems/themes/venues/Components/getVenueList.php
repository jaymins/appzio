...
trait getVenueList
{
     ...
     * @return \stdClass
     */
    public function getVenueList(string $title, array $description = array(), array $parameters=array(), array $styles=array()) {
        ...
        if ( $description AND isset($parameters['date_icon']) ) {
            ...
            $data[] = $this->getComponentRow(array(
                ...
                $this->getComponentColumn($this->descItem($description), array(), array(
                    'width' => 'auto'
                )),
            ), array(), array(
                'padding' => '10 15 0 15',
        ...
        $data[] = $this->getComponentSpacer(10);
        $data[] = $this->getComponentDivider();
    ...
    private function descItem( $description ) {
