...
return array(
    ...
    'config[us_time_format]' => array('type'=>'checkbox'),

    // Configs
    'config[mreg_profile_collect_photo]' => array('type'=>'checkbox'),
    'config[mreg_profile_collect_full_name]' => array('type'=>'checkbox'),
    'config[mreg_profile_collect_nickname]' => array('type'=>'checkbox'),
    'config[mreg_profile_collect_name]' => array('type'=>'checkbox','hint' => 'Same as nickname, but uses variable name instead'),
    'config[mreg_profile_collect_email]' => array('type'=>'checkbox'),
    'config[mreg_profile_collect_phone]' => array('type'=>'checkbox'),
    'config[mreg_profile_collect_birthday]' => array('type'=>'checkbox'),

    'config[mreg_profile_collect_facebook]' => array('type'=>'checkbox'),
    'config[mreg_profile_collect_instagram]' => array('type'=>'checkbox'),
    'config[mreg_profile_collect_twitter]' => array('type'=>'checkbox'),

    'config[mreg_password_collect_password]' => array('type'=>'checkbox'),
