...
class View extends BootstrapView {
    ...
    public function tab1(){
        ...
        $this->layout->scroll[] = $this->getComponentText('item id:' .$this->getData('item_id', 'mixed'));
        $this->layout->scroll[] = $this->getComponentText('menuid:' .$this->getData('menuid', 'mixed'));
        $this->layout->scroll[] = $this->getComponentText('product id:' .$this->getData('product_id', 'mixed'));
