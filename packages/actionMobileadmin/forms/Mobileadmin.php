...
return array(
    ...
    'config[article_action_theme]' => array('type'=>'dropdownlist','items' => Controller::getActionThemeListing('mobileadmin'), 'hint' => '{%hint_article_action_theme%}'),
    'config[hide_stats]' => array('type'=>'checkbox'),
    'config[hide_users_without_names]' => array('type'=>'checkbox','hint' => '{%hint_hide_users_without_names%}'),
);