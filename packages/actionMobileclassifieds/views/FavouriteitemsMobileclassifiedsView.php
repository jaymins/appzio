...
class FavouriteitemsMobileclassifiedsView extends MobileclassifiedsView {
    ...
    private function renderItems()
    {
        if ($this->menuid == 'searchbox') {
            ...
            $items = $this->itemsModel->getFavouriteItems($searchterm);
        } else {
            $items = $this->itemsModel->getFavouriteItems();
        }
    ...
    private function renderItem($item)
    {
        ...
        $row[] = $this->getRow([
            ...
            $this->getImage($item['favourite'] ? 'star_selected.png' : 'star_not_selected.png', [
                'crop' => 'yes',
                'width' => '20',
                'floating' => 1,
                'float' => 'right',
