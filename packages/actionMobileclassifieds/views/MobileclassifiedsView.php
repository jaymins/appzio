...
class MobileclassifiedsView extends MobileclassifiedsController {
    ...
    public function tab1(){
        ...
        $this->setHeader();
        $this->data->scroll[] = $this->getText($this->getConfigParam('mode'));
    ...
    public function tab3(){
        ...
        $row[] = $this->getFieldtext($value,array('style' => 'example_searchbox_text',
            ...
            //'suggestions' => MobileclassifiedsAccessor::getInitialWordList(10),
            //'id' => 'something',
        ...
        if($this->menuid == 'searchbox'){
            if(isset($this->submitvariables['searchterm']) AND strlen($this->submitvariables['searchterm']) > 0){
                ...
                $wordlist = MobileclassifiedsAccessor::getLetter($searchterm,10);
