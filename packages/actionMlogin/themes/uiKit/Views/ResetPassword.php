...
/*    public function __construct($obj)
    ...
    {
        $form[] = $this->components->uiKitGeneralField('temp_code', '{#code#}', 'icon-envelope.png');
        $form[] = $this->components->uiKitDivider();

        $form[] = $this->components->uiKitGeneralField('password', '{#new_password#}', 'icon-key.png');
        $form[] = $this->components->uiKitDivider();

        $form[] = $this->components->uiKitGeneralField('confirm_password', '{#confirm_password#}', 'icon-key.png');
        $form[] = $this->components->uiKitDivider();
