...
class oliveMobileloginSubController extends MobileloginController {
    ...
    public function tab1(){
        ...
        /*        $loginstarted = Appcaching::getGlobalCache($this->playid.'-regstart');

                if($this->getSavedVariable('instagram_token') AND strlen($this->getSavedVariable('instagram_token')) > 10 AND $this->getSavedVariable('logged_in') == '1' AND $loginstarted){
    ...
    public function doLogout(){
        ...
        $this->data->scroll[] = $this->getText('{#logged_out#}',array( 'style' => 'mobile-login-general-text'));
        ...
        $this->data->footer[] = $this->getTextbutton('{#login_again#}',array('action' => 'complete-action','id' => 'complete'));
...
//      $this->loadVariableContent(true);
    ...
    public function getCodeEntryForm(){
        ...
        $this->data->scroll[] = $this->getFieldWithIcon('icon_pw.png',$this->getVariableId('password_code'),'{#enter_code_from_email#}');
    ...
    public function lostPassForm($error=false){
        ...
        $this->setHeader();
        $this->data->scroll[] = $this->getFieldWithIcon('icon_email.png','email-to-reset','Email',$error);
