...
return array(
    ...
    'config[article_action_theme]' => array('type'=>'dropdownlist','items' => Controller::getActionThemeListing('mobilebeaconadmin'), 'hint' => '{%hint_article_action_theme%}'),
    ...
    'config[region]' => array('type'=>'text', 'title'=>'{%beacon_region%}'),
    'config[estimote_app_id]' => array('type'=>'text', 'title'=>'{%beacon_region%}'),
    'config[estimote_app_token]' => array('type'=>'text', 'title'=>'{%beacon_region%}'),
