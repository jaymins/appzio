...
class BbsModelOld extends CActiveRecord
{
...
/**
	...
	public function relations()
	{
		...
		return array(
			'aeplayaction' => array(self::BELONGS_TO, 'AeplayAction', 'playtask_id'),
		);
    }
	

    public static function getGameDiaries($gid){
        $sql = 'SELECT *,
	...
	*/
	...
	private function addInitialGameData(){
    	...
    	$levels = '1';
    	$headboard = 'changeme.jpg';
    	$sql = "UPDATE ae_game SET alert = '$alert', levels = '$levels', headboard = '$headboard'
