...
class BbsPostModel extends BbsModel
{
...
/**
	...
	public function relations()
	{
		...
		return array(
			'bbs' => array(self::BELONGS_TO, 'BbsModel', 'bbs_id'),
		);
    }
    ...
    public static function getPosts($actionid){
        $sql = 'SELECT *,
                      ...
                      ae_ext_bbs_post.msg AS `reply`,
                      ae_ext_bbs.msg AS msg,
                      ae_ext_bbs.date AS maindate,
                      (SELECT * FROM ae_ext_bbs_post WHERE bbs_id = entryid)
                    FROM ae_ext_bbs
                    LEFT JOIN ae_ext_bbs_post ON
                    ...
                    WHERE ae_ext_bbs.playtask_id = :actionId
                    GROUP BY entryid
                    ORDER BY ae_ext_bbs.date, ae_ext_bbs_post.date DESC
