...
return array(
    ...
    //'config[article_action_theme]' => array('type'=>'dropdownlist','items' => Controller::getActionThemeListing('mobilegolf'), 'hint' => '{%hint_article_action_theme%}'),
    ...
    'config[google_adcode_banners]' => array('type'=>'text', 'title'=>'{%bannercode%}'),
    'config[monitor_region]' => array('type'=>'text', 'title'=>'{%bannercode%}'),
    ...
    'config[events_action]' => array('type' => 'dropdownlist',
        'items' => $actions,
        'hint' => '{%choose_branch%}'
    ),
