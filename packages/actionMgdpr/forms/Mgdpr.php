...
return array(
    ...
    // alert
    'config[show_delete]' => array('type'=>'checkbox', 'title'=>'%alertbox%'),
    'config[shown_in_popup]' => array('type'=>'checkbox', 'title'=>'%alertbox%'),
    'config[home_action]' => array('type'=>'dropdownlist','items' => CHtml::listData(Aeaction::getAllActions($this->gid),'id','name'), 'hint' => 'Home when user is not logged in'),
    'config[home_action_logged_in]' => array('type'=>'dropdownlist','items' => CHtml::listData(Aeaction::getAllActions($this->gid),'id','name'), 'hint' => 'Home when user is logged in'),
    'config[headertext]' => array('type'=>'textarea', 'hint'=>'General intro text, shown above terms'),

    'config[terms]' => array('type'=>'textarea', 'title'=>'%alertbox%','style' => 'height:200px;', 'hint'=>'General terms'),
    'config[privacy]' => array('type'=>'textarea', 'title'=>'%alertbox%','style' => 'height:200px;', 'hint'=>'Optional, but recommended. Privacy policy.'),
    'config[subscriptions_ios]' => array('type'=>'textarea', 'title'=>'%alertbox%','style' => 'height:200px;', 'hint'=>'Required if subscriptions are enabled.'),
    'config[subscriptions_android]' => array('type'=>'textarea', 'title'=>'%alertbox%','style' => 'height:200px;', 'hint'=>'Required if subscriptions are enabled.'),
