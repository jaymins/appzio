...
return array(
    ...
    // Configs
    'config[mplug_collect_photo]' => array('type'=>'checkbox'),
    'config[mplug_collect_full_name]' => array('type'=>'checkbox'),
    'config[mplug_collect_nickname]' => array('type'=>'checkbox'),
    'config[mplug_collect_email]' => array('type'=>'checkbox'),
    'config[mplug_email_strict_validation]' => array('type'=>'checkbox'),

    'config[mplug_collect_phone]' => array('type'=>'checkbox'),

    'config[mplug_collect_profile_comment]' => array('type'=>'checkbox'),
    'config[mplug_hint_text_for_profile_comment]' => array('type'=>'textarea'),

    'config[mplug_social_facebook]' => array('type'=>'checkbox'),
    'config[mplug_social_twitter]' => array('type'=>'checkbox'),
    'config[mplug_social_google]' => array('type'=>'checkbox'),
    'config[mplug_social_instagram]' => array('type'=>'checkbox'),

    'config[mplug_collect_terms]' => array('type'=>'checkbox'),
    'config[mplug_terms_action]' => array('type' => 'dropdownlist',
        'items' => $actions,
