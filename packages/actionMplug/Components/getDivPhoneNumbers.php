...
trait getDivPhoneNumbers {
     ...
     * </code>
     * @return \stdClass
     * @link packages\actionMplug\Components\getPhoneNumberField
     */
    ...
    public function getDivPhoneNumbers(){
        ...
        $content[] = $this->getComponentFormFieldList($list,array(
            ...
            'style' => 'mplug_selectlist',
            'value' => $value
        ));

        $cols[] = $this->getComponentText('{#cancel#}',array('style' => 'mplug_small_btn','onclick' => $this->getOnclickHideDiv('countries')));
        $cols[] = $this->getComponentText('{#select#}',array('style' => 'mplug_small_btn',
