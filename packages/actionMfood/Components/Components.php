...
use BootstrapThemes\Swiss8\Components\Swiss8Components;


class Components extends Swiss8Components
{
    // use Header;
    use HeaderImage;
    use DivAddShoppingListItem;
    use DivSelectYourCookDays;
    use RecipeListRow;
    use ShoppingListCategory;
    use SelectListCategory;
}