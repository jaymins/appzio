...
return array(
    ...
    'config[article_action_theme]' => array('type'=>'dropdownlist','items' => Controller::getActionThemeListing('mobilelocation'), 'hint' => '{%hint_article_action_theme%}'),
    'config[email]' => array('type'=>'checkbox', 'hint' => '{%menu_for_submit_button%}'),
    'config[phone]' => array('type'=>'checkbox', 'hint' => '{%menu_for_submit_button%}'),
    'config[facebook]' => array('type'=>'checkbox', 'hint' => '{%menu_for_submit_button%}'),
    'config[msg]' => array('type'=>'checkbox', 'hint' => '{%menu_for_submit_button%}'),
);