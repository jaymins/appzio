...
namespace packages\actionBasezio\Views;
...
class View extends BootstrapView {
     ...
     * @var \packages\actionBasezio\Components\Components
     */
    public $components;
    public $theme;
...
//        }
        ...
        $this->layout->scroll[] = $this->getComponentImage('logo3.png', array(), array(
            'width' => '200',
            'margin' => '30 80 10 80',
        ));

        $this->layout->scroll[]  = $this->getComponentText('Welcom to Basezio', array(), array(
            'text-align' => 'center',
            'font-weight' => 'bold',
            'padding' => '10 10 10 10',
            'font-size' => '24'
...
//        $btn[] = $this->getComponentText('Data',
...
//            $btn3,$btn1,$btn2
//        ]);
        //$this->layout->footer[] = $this->getComponentRow($btn3,array('style' => 'mreg_btn_row3'));
       // $this->layout->footer[] = $this->getComponentRow($btn1,array('style' => 'mreg_btn_row1'));
       // $this->layout->footer[] = $this->getComponentRow($btn2,array('style' => 'mreg_btn_row2'));
        return $this->layout;
    }
