...
class MobilesearchController extends ArticleController {
    ...
    public function tab1(){
        ...
        Yii::import('application.modules.aelogic.packages.actionMobilesearch.models.*');
        ...
        $row[] = $this->getFieldtext($value,array('style' => 'example_searchbox_text',
            ...
            //'suggestions' => MobilesearchAccessor::getInitialWordList(10),
            'id' => 'something',
        ...
        if($this->menuid == 'searchbox'){
            if(isset($this->submitvariables['searchterm']) AND strlen($this->submitvariables['searchterm']) > 0){
                ...
                $this->data->scroll[] = $this->getText($searchterm);
                $wordlist = MobilesearchModel::searchUsers($searchterm,$this->gid,50);

                print_r($wordlist);die();
/*                                $wordlist = MobilesearchAccessor::getLetter($searchterm,10);
