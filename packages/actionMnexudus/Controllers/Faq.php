...
class Faq extends Controller {
    ...
    public function actionDefault(){
        ...
        $this->data['faq_items'] = $this->model->getFaqItems();
        $this->data['header'] = $this->model->getConfigParam('description');
        $this->data['subject'] = $this->model->getConfigParam('subject');
        return ['Faq',$this->data];
    }
