...
class Makebooking3 extends Makebooking2 {
    ...
    public function tab1(){
        ...
        $this->layout->scroll[] = $this->getComponentText('{#succesfull_booking#}',['style' => 'uikit_information_tile_title']);
        $this->layout->scroll[] = $this->getComponentText('{#your_booking_has_been_created#}',['style' => 'nexudus_uikit_formheader']);
