...
return array(
    ...
    // 'config[article_action_theme]' => array('type'=>'dropdownlist','items' => Controller::getActionThemeListing('mobileversionupdate'), 'hint' => '{%hint_article_action_theme%}'),
    'config[minimum_client_version]' => array('type'=>'text', 'title'=>'%subject%'),
