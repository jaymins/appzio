...
*/
    'config[time_to_wait]' => array('type'=>'text', 'title'=>'%subject%','hint' => 'Time in minutes'),
    'config[mode]' => array('type'=>'dropdownlist', 'items'=>$modes,'title'=>'%subject%','hint' => 'Time in minutes'),
