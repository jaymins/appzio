...
namespace packages\actionMmenus\Controllers;
use Bootstrap\Controllers\BootstrapController;
use packages\actionMmenus\Views\Main as ArticleView;
use packages\actionMmenus\Models\Model as ArticleModel;

class Main extends BootstrapController {
