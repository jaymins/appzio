...
$config = array(
    ...
    'config[article_action_theme]' => array('type'=>'dropdownlist','items' => Controller::getActionThemeListing($shortname, true), 'hint' => '{%hint_article_action_theme%}'),
    'config[mode]' => array(
        'type' => 'dropdownlist',
        'items' => $mode,
        'onChange' => 'this.form.submit()',
        'reload' => 'true',
        'hint' => '{%hint_article_action_mode%}'
    ),
    'config[default_category]' => array('type' => 'text', 'hint' => '{%hint_article_action_mode%}'),
);

$config['config[article_id]'] =  array('type'=>'text', 'title'=>'%hint_article_id%');
