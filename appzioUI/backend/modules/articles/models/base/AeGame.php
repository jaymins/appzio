 ...
 *
 * @property \backend\modules\articles\models\AeApiFilelookup[] $aeApiFilelookups
 * @property \backend\modules\articles\models\AeAppMenu[] $aeAppMenus
 ...
 * @property \backend\modules\articles\models\AeExtArticleCategory[] $aeExtArticleCategories
 * @property \backend\modules\articles\models\AeExtArticleTag[] $aeExtArticleTags
 * @property \backend\modules\articles\models\AeExtDealsLog[] $aeExtDealsLogs
 * @property \backend\modules\articles\models\AeExtItem[] $aeExtItems
 * @property \backend\modules\articles\models\AeExtItemsCategory[] $aeExtItemsCategories
 ...
 * @property \backend\modules\articles\models\AeExtMobilefeedbacktoolDepartment[] $aeExtMobilefeedbacktoolDepartments
 * @property \backend\modules\articles\models\AeExtMobilefeedbacktoolFundamental[] $aeExtMobilefeedbacktoolFundamentals
 ...
 * @property \backend\modules\articles\models\AeExtMobileplace[] $aeExtMobileplaces
 ...
 * @property \backend\modules\articles\models\AeExtProductsCategory[] $aeExtProductsCategories
 * @property \backend\modules\articles\models\AeExtProductsTag[] $aeExtProductsTags
 * @property \backend\modules\articles\models\AeExtTattoo[] $aeExtTattoos
 * @property \backend\modules\articles\models\AeFilename[] $aeFilenames
 * @property \backend\modules\articles\models\AeCategory $category
 * @property \backend\modules\articles\models\UsergroupsUser $user
 * @property \backend\modules\articles\models\AeGameBadge[] $aeGameBadges
 * @property \backend\modules\articles\models\AeGameBadge[] $aeGameBadges0
 * @property \backend\modules\articles\models\AeGameBranch[] $aeGameBranches
 * @property \backend\modules\articles\models\AeGameKeyvaluestorage[] $aeGameKeyvaluestorages
 * @property \backend\modules\articles\models\AeGamePlay[] $aeGamePlays
 * @property \backend\modules\articles\models\AeGameRole[] $aeGameRoles
 * @property \backend\modules\articles\models\AeGameScore[] $aeGameScores
 * @property \backend\modules\articles\models\AeGameVariable[] $aeGameVariables
 * @property \backend\modules\articles\models\AeLocationLog[] $aeLocationLogs
 * @property \backend\modules\articles\models\AeMobile $aeMobile
 * @property \backend\modules\articles\models\AePackage[] $aePackages
 * @property \backend\modules\articles\models\AePackagesTheme[] $aePackagesThemes
...
abstract class AeGame extends \backend\models\CrudBase
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\articles\models\AeCategory::className(), 'targetAttribute' => ['category_id' => 'id']],
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeApiFilelookup::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeAppMenu::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeChat::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtArticle::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtArticleCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtArticleTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtDealsLog::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtItem::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtItemsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobileevent::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobilefeedbacktool::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobilefeedbacktoolDepartment::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobilefeedbacktoolFundamental::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobilefeedbacktoolTeam::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobilematching::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobileplace::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobileproperty::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtMobilepropertyBookmark::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtNotification::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtProduct::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtProductsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtProductsTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeExtTattoo::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeFilename::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\articles\models\AeCategory::className(), ['id' => 'category_id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeGameBadge::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeGameBranch::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeGameKeyvaluestorage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeGamePlay::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeGameRole::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeGameScore::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeGameVariable::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AeLocationLog::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\articles\models\AeMobile::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AePackage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AePackagesTheme::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\articles\models\AePurchase::className(), ['game_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\articles\models\query\AeGameQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\articles\models\query\AeGameQuery(get_called_class());
    }
