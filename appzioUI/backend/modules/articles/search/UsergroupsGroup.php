...
use backend\modules\articles\models\UsergroupsGroup as UsergroupsGroupModel;

/**
* UsergroupsGroup represents the model behind the search form about `backend\modules\articles\models\UsergroupsGroup`.
*/
