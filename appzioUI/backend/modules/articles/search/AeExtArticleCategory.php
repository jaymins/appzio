...
use backend\modules\articles\models\AeExtArticleCategory as AeExtArticleCategoryModel;

/**
* AeExtArticleCategory represents the model behind the search form about `backend\modules\articles\models\AeExtArticleCategory`.
*/
