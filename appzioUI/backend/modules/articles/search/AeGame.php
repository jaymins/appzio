...
use backend\modules\articles\models\AeGame as AeGameModel;

/**
* AeGame represents the model behind the search form about `backend\modules\articles\models\AeGame`.
*/
