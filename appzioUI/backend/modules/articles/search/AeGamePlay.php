...
use backend\modules\articles\models\AeGamePlay as AeGamePlayModel;

/**
* AeGamePlay represents the model behind the search form about `backend\modules\articles\models\AeGamePlay`.
*/
