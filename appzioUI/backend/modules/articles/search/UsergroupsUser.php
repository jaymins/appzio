...
use backend\modules\articles\models\UsergroupsUser as UsergroupsUserModel;

/**
* UsergroupsUser represents the model behind the search form about `backend\modules\articles\models\UsergroupsUser`.
*/
