...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\articles\search\AeExtArticleBookmark $searchModel
*/

$this->title = Yii::t('backend', 'Article Bookmarks');
...
?>
<div class="giiant-crud ae-ext-article-bookmark-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Article Bookmarks') ?>
        <small>
            List
        </small>
    </h1>
