...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\articles\search\AeGame $searchModel
*/
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [
            [
                'url' => ['/articles/ae-ext-article/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Article'),
            ],
                                [
                'url' => ['/articles/ae-ext-article-category/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Article Category'),
            ],
                                [
                'url' => ['/articles/ae-ext-article-tag/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Article Tag'),
            ],
                                [
                'url' => ['/articles/ae-category/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Category'),
            ],
                                [
                'url' => ['/articles/usergroups-user/index'],
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getCategory()->one()) {
			            return Html::a($rel->name, ['/articles/ae-category/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
