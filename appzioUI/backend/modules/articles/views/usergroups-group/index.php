...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\articles\search\UsergroupsGroup $searchModel
*/

$this->title = Yii::t('backend', 'Usergroups Groups');
...
?>
<div class="giiant-crud usergroups-group-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Usergroups Groups') ?>
        <small>
            List
        </small>
    </h1>
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Usergroups User'),
            ],
