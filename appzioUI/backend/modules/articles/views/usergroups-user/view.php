...
<div class="giiant-crud usergroups-user-view">
    ...
    <?php $this->beginBlock('backend\modules\articles\models\UsergroupsUser'); ?>
...
[
    ...
    'value' => ($model->getGroup()->one() ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/articles/usergroups-group/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getGroup()->one()->id, ['/articles/usergroups-group/view', 'id' => $model->getGroup()->one()->id,]).' '.
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/articles/ae-game/create', 'AeGame' => ['user_id' => $model->id]],
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/articles/ae-game-play/create', 'AeGamePlay' => ['user_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\articles\models\UsergroupsUser'],
    'active'  => true,
],
[
