 ...
 * @var backend\modules\articles\search\AeExtArticleTemplate $searchModel
 */

$this->title = Yii::t('backend', 'Article Templates');
...
?>
<div class="giiant-crud ae-ext-article-template-index">
    ...
    <h1>
        <?= Yii::t('backend', 'Article Templates') ?>
        <small>
            List
        </small>
    </h1>
