...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\articles\search\AeExtArticleComment $searchModel
*/

$this->title = Yii::t('backend', 'Article Comments');
...
?>
<div class="giiant-crud ae-ext-article-comment-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Article Comments') ?>
        <small>
            List
        </small>
    </h1>
