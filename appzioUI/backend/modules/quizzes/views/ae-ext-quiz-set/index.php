...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\quizzes\search\AeExtQuizSet $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Quiz Sets');
...
?>
<div class="giiant-crud ae-ext-quiz-set-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Quiz Sets') ?>
        <small>
            List
        </small>
    </h1>
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Game'),
                                ...
                                [
                'url' => ['/quizzes/ae-ext-quiz/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Quiz'),
            ],
                                [
                'url' => ['/quizzes/ae-ext-quiz-question/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Quiz Question'),
            ],
