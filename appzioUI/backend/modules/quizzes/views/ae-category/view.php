...
<div class="giiant-crud ae-category-view">
    ...
    <?php $this->beginBlock('backend\modules\quizzes\models\AeCategory'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/quizzes/ae-game/create', 'AeGame' => ['category_id' => $model->id]],
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->user) {
            return Html::a($rel->id, ['/quizzes/usergroups-user/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\quizzes\models\AeCategory'],
    'active'  => true,
],
[
