...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\quizzes\search\AeExtQuizQuestion $searchModel
*/

$this->title = Yii::t('backend', 'Quiz Questions');
...
?>
<div class="giiant-crud ae-ext-quiz-question-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Question Option'),
            ],
                                [
                'url' => ['/quizzes/ae-ext-quiz-set/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Quiz Set'),
            ],
