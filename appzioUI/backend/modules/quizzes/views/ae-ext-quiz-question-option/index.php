...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\quizzes\search\AeExtQuizQuestionOption $searchModel
*/

$this->title = Yii::t('backend', 'Question Options');
...
?>
<div class="giiant-crud ae-ext-quiz-question-option-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Question Options') ?>
        <small>
            List
        </small>
    </h1>
