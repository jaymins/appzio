...
<div class="giiant-crud ae-game-view">
    ...
    <?php $this->beginBlock('backend\modules\quizzes\models\AeGame'); ?>
...
[
    ...
    'attribute' => 'user_id',
    'value' => ($model->user ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/quizzes/usergroups-user/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->user->id, ['/quizzes/usergroups-user/view', 'id' => $model->user->id,]).' '.
...
[
    ...
    'value' => ($model->category ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/quizzes/ae-category/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->category->name, ['/quizzes/ae-category/view', 'id' => $model->category->id,]).' '.
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/quizzes/ae-ext-quiz-set/create', 'AeExtQuizSet' => ['app_id' => $model->id]],
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['AeExtQuizSet'] = ['app_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\quizzes\models\AeGame'],
    'active'  => true,
],
[
