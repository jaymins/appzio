...
use backend\modules\quizzes\models\UsergroupsUser as UsergroupsUserModel;

/**
* UsergroupsUser represents the model behind the search form about `backend\modules\quizzes\models\UsergroupsUser`.
*/
