...
use backend\modules\quizzes\models\AeGame as AeGameModel;

/**
* AeGame represents the model behind the search form about `backend\modules\quizzes\models\AeGame`.
*/
