...
use backend\modules\quizzes\models\UsergroupsGroup as UsergroupsGroupModel;

/**
* UsergroupsGroup represents the model behind the search form about `backend\modules\quizzes\models\UsergroupsGroup`.
*/
