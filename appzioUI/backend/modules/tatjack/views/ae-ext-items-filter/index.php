...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\AeExtItemsFilter $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Items Filters');
...
?>
<div class="giiant-crud ae-ext-items-filter-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Items Filters') ?>
        <small>
            List
        </small>
    </h1>
