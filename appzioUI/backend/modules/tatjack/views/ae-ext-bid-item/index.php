...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\AeExtBidItem $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Bid Items');
...
?>
<div class="giiant-crud ae-ext-bid-item-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Bid Items') ?>
        <small>
            List
        </small>
    </h1>
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Game Play'),
                                ...
                                [
                'url' => ['/tatjack/ae-ext-user-bid-item-image/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext User Bid Item Image'),
            ],
                                [
                'url' => ['/tatjack/ae-ext-user-bid/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext User Bid'),
            ],
