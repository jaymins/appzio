...
<!-- attribute variable_id -->
			<?= // generated by schmunk42\giiant\generators\crud\providers\core\RelationProvider::activeField
$form->field($model, 'variable_id')->dropDownList(
    \yii\helpers\ArrayHelper::map(backend\modules\tatjack\models\AeGameVariable::find()->all(), 'id', 'name'),
    [
        'prompt' => Yii::t('backend', 'Select'),
        'disabled' => (isset($relAttributes) && isset($relAttributes['variable_id'])),
    ]
); ?>
