...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\AeExtItemsTag $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Items Tags');
...
?>
<div class="giiant-crud ae-ext-items-tag-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Items Tags') ?>
        <small>
            List
        </small>
    </h1>
