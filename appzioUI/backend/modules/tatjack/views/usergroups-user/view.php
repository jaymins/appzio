...
<div class="giiant-crud usergroups-user-view">
    ...
    <?php $this->beginBlock('backend\modules\tatjack\models\UsergroupsUser'); ?>
...
[
    ...
    'value' => ($model->getGroup()->one() ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/tatjack/usergroups-group/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getGroup()->one()->id, ['/tatjack/usergroups-group/view', 'id' => $model->getGroup()->one()->id,]).' '.
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params[0] = '/tatjack/ae-game' . '/' . $action;
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/tatjack/ae-game-play/create', 'AeGamePlay' => ['user_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\tatjack\models\UsergroupsUser'],
    'active'  => true,
],
[
