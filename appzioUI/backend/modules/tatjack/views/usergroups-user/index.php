...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\UsergroupsUser $searchModel
*/
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Game Play'),
                                ...
                                [
                'url' => ['/tatjack/usergroups-group/index'],
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getGroup()->one()) {
			            return Html::a($rel->id, ['/tatjack/usergroups-group/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
