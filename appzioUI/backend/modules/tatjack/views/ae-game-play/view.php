...
<div class="giiant-crud ae-game-play-view">
    ...
    <?php $this->beginBlock('backend\modules\tatjack\models\AeGamePlay'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/tatjack/ae-ext-item/create', 'AeExtItem' => ['play_id' => $model->id]],
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('backend', 'New') . ' Ae Ext Items Like',
            ['/tatjack/ae-ext-items-like/create', 'AeExtItemsLike' => ['play_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['AeExtItemsLike'] = ['play_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('backend', 'New') . ' Ae Ext Items Report',
            ['/tatjack/ae-ext-items-report/create', 'AeExtItemsReport' => ['play_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['AeExtItemsReport'] = ['play_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
...
<?php $this->beginBlock('AeExtItemsReports0s'); ?>
<div style='position: relative'>
<div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            '<span class="glyphicon glyphicon-list"></span> ' . Yii::t('backend', 'List All') . ' Ae Ext Items Reports0s',
            ['/tatjack/ae-ext-items-report/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('backend', 'New') . ' Ae Ext Items Reports0',
            ['/tatjack/ae-ext-items-report/create', 'AeExtItemsReport' => ['item_owner_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
<?php Pjax::begin(['id'=>'pjax-AeExtItemsReports0s', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-AeExtItemsReports0s ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?=
 '<div class="table-responsive">'
 . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
    'dataProvider' => new \yii\data\ActiveDataProvider([
        ...
        'pagination' => [
            'pageSize' => 20,
            'pageParam'=>'page-aeextitemsreports0s',
        ]
    ]),
    'pager'        => [
        'class'          => yii\widgets\LinkPager::className(),
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params = is_array($key) ? $key : [$model->primaryKey()[0] => (string) $key];
        $params[0] = '/tatjack/ae-ext-items-report' . '/' . $action;
        $params['AeExtItemsReport'] = ['item_owner_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\tatjack\models\AeGamePlay'],
    'active'  => true,
],
[
...
[
    'content' => $this->blocks['AeExtItemsReports0s'],
    'label'   => '<small>Ae Ext Items Reports0s <span class="badge badge-default">'.count($model->getAeExtItemsReports()->asArray()->all()).'</span></small>',
    'active'  => false,
],
 ]
                 ]
