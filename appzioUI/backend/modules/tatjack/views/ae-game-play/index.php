...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\AeGamePlay $searchModel
*/
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Item'),
                                ...
                                [
                'url' => ['/tatjack/ae-ext-items-like/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Items Like'),
            ],
                                [
                'url' => ['/tatjack/ae-ext-items-report/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Items Report'),
            ],
                                [
                'url' => ['/tatjack/ae-ext-items-report/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Items Report'),
