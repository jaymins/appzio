...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\AeGameVariable $searchModel
*/

$this->title = Yii::t('backend', 'Ae Game Variables');
...
?>
<div class="giiant-crud ae-game-variable-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Game Variables') ?>
        <small>
            List
        </small>
    </h1>
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [
            [
                'url' => ['/tatjack/ae-game-play-variable/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Game Play Variable'),
            ],
                                [
