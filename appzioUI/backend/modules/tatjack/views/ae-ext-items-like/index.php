...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\AeExtItemsLike $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Items Likes');
...
?>
<div class="giiant-crud ae-ext-items-like-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Items Likes') ?>
        <small>
            List
        </small>
    </h1>
