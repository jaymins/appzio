...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\AeExtItemsReport $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Items Reports');
...
?>
<div class="giiant-crud ae-ext-items-report-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Items Reports') ?>
        <small>
            List
        </small>
    </h1>
