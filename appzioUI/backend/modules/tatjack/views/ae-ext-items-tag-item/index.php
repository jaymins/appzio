...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tatjack\search\AeExtItemsTagItem $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Items Tag Items');
...
?>
<div class="giiant-crud ae-ext-items-tag-item-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Items Tag Items') ?>
        <small>
            List
        </small>
    </h1>
