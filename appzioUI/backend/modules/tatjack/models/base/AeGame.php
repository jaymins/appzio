 ...
 *
 * @property \backend\modules\tatjack\models\AeApiFilelookup[] $aeApiFilelookups
 * @property \backend\modules\tatjack\models\AeAppMenu[] $aeAppMenus
 * @property \backend\modules\tatjack\models\AeChat[] $aeChats
 * @property \backend\modules\tatjack\models\AeExtDealsLog[] $aeExtDealsLogs
 * @property \backend\modules\tatjack\models\AeExtItem[] $aeExtItems
 * @property \backend\modules\tatjack\models\AeExtItemsCategory[] $aeExtItemsCategories
 ...
 * @property \backend\modules\tatjack\models\AeExtMobilefeedbacktoolDepartment[] $aeExtMobilefeedbacktoolDepartments
 * @property \backend\modules\tatjack\models\AeExtMobilefeedbacktoolFundamental[] $aeExtMobilefeedbacktoolFundamentals
 ...
 * @property \backend\modules\tatjack\models\AeExtMobileplace[] $aeExtMobileplaces
 ...
 * @property \backend\modules\tatjack\models\AeExtProductsCategory[] $aeExtProductsCategories
 * @property \backend\modules\tatjack\models\AeExtProductsTag[] $aeExtProductsTags
 * @property \backend\modules\tatjack\models\AeExtTattoo[] $aeExtTattoos
 * @property \backend\modules\tatjack\models\AeFilename[] $aeFilenames
 * @property \backend\modules\tatjack\models\AeCategory $category
 * @property \backend\modules\tatjack\models\UsergroupsUser $user
 * @property \backend\modules\tatjack\models\AeGameBadge[] $aeGameBadges
 * @property \backend\modules\tatjack\models\AeGameBadge[] $aeGameBadges0
 * @property \backend\modules\tatjack\models\AeGameBranch[] $aeGameBranches
 * @property \backend\modules\tatjack\models\AeGameKeyvaluestorage[] $aeGameKeyvaluestorages
 * @property \backend\modules\tatjack\models\AeGamePlay[] $aeGamePlays
 * @property \backend\modules\tatjack\models\AeGameRole[] $aeGameRoles
 * @property \backend\modules\tatjack\models\AeGameScore[] $aeGameScores
 * @property \backend\modules\tatjack\models\AeGameVariable[] $aeGameVariables
 * @property \backend\modules\tatjack\models\AeLocationLog[] $aeLocationLogs
 * @property \backend\modules\tatjack\models\AeMobile $aeMobile
...
abstract class AeGame extends \backend\models\CrudBase
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\tatjack\models\AeCategory::className(), 'targetAttribute' => ['category_id' => 'id']],
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeApiFilelookup::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeAppMenu::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeChat::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtDealsLog::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtItem::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtItemsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobileevent::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobilefeedbacktool::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobilefeedbacktoolDepartment::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobilefeedbacktoolFundamental::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobilefeedbacktoolTeam::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobilematching::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobileplace::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobileproperty::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtMobilepropertyBookmark::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtNotification::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtProduct::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtProductsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtProductsTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtTattoo::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeFilename::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\tatjack\models\AeCategory::className(), ['id' => 'category_id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGameBadge::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGameBranch::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGameKeyvaluestorage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGamePlay::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGameRole::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGameScore::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGameVariable::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeLocationLog::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\tatjack\models\AeMobile::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AePurchase::className(), ['game_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\tatjack\models\query\AeGameQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\tatjack\models\query\AeGameQuery(get_called_class());
    }
