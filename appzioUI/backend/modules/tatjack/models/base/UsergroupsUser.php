 ...
 * @property \backend\modules\tatjack\models\AeChannelSettingUser[] $aeChannelSettingUsers
 * @property \backend\modules\tatjack\models\AeChannelUser[] $aeChannelUsers
 * @property \backend\modules\tatjack\models\AeChannel[] $idChannels
 * @property \backend\modules\tatjack\models\AeExtBb[] $aeExtBbs
 * @property \backend\modules\tatjack\models\AeExtDiary[] $aeExtDiaries
 * @property \backend\modules\tatjack\models\AeFbInvite[] $aeFbInvites
 * @property \backend\modules\tatjack\models\AeFbfriendUser[] $aeFbfriendUsers
 * @property \backend\modules\tatjack\models\AeFbfriend[] $aeFbfriends
 * @property \backend\modules\tatjack\models\AeGame[] $aeGames
 * @property \backend\modules\tatjack\models\AeGameBranchActionType[] $aeGameBranchActionTypes
 ...
 * @property \backend\modules\tatjack\models\AeGameTrigger[] $aeGameTriggers
 * @property \backend\modules\tatjack\models\AeRoleUser[] $aeRoleUsers
 * @property \backend\modules\tatjack\models\SshKey[] $sshKeys
 * @property \backend\modules\tatjack\models\UsergroupsGroup $group
...
abstract class UsergroupsUser extends \backend\models\CrudBase
{
    ...
    public function rules()
    {
        return [
            ...
            [['username'], 'unique'],
            [['group_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\tatjack\models\UsergroupsGroup::className(), 'targetAttribute' => ['group_id' => 'id']]
        ];
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeAccessToken::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeChannelSettingUser::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeChannelUser::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeChannel::className(), ['id' => 'id_channel'])->viaTable('ae_channel_user', ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtBb::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeExtDiary::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeFbInvite::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeFbfriendUser::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeFbfriend::className(), ['id' => 'ae_fbfriend_id'])->viaTable('ae_fbfriend_user', ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGame::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGameBranchActionType::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGamePlay::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGamePlayAction::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGamePlayUser::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeGameTrigger::className(), ['id_user' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\AeRoleUser::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tatjack\models\SshKey::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\tatjack\models\UsergroupsGroup::className(), ['id' => 'group_id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\tatjack\models\query\UsergroupsUserQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\tatjack\models\query\UsergroupsUserQuery(get_called_class());
    }
