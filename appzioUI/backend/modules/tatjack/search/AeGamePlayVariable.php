...
use backend\modules\tatjack\models\AeGamePlayVariable as AeGamePlayVariableModel;

/**
* AeGamePlayVariable represents the model behind the search form about `backend\modules\tatjack\models\AeGamePlayVariable`.
*/
