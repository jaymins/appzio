...
use backend\modules\tatjack\models\UsergroupsUser as UsergroupsUserModel;

/**
* UsergroupsUser represents the model behind the search form about `backend\modules\tatjack\models\UsergroupsUser`.
*/
