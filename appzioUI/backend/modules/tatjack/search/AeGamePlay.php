...
use backend\modules\tatjack\models\AeGamePlay as AeGamePlayModel;

/**
* AeGamePlay represents the model behind the search form about `backend\modules\tatjack\models\AeGamePlay`.
*/
