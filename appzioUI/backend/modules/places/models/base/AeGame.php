 ...
 *
 * @property \backend\modules\places\models\AeApiFilelookup[] $aeApiFilelookups
 * @property \backend\modules\places\models\AeAppMenu[] $aeAppMenus
 * @property \backend\modules\places\models\AeChat[] $aeChats
 * @property \backend\modules\places\models\AeExtDealsLog[] $aeExtDealsLogs
 * @property \backend\modules\places\models\AeExtItem[] $aeExtItems
 * @property \backend\modules\places\models\AeExtItemsCategory[] $aeExtItemsCategories
 * @property \backend\modules\places\models\AeExtMobileevent[] $aeExtMobileevents
 * @property \backend\modules\places\models\AeExtMobilefeedbacktool[] $aeExtMobilefeedbacktools
 * @property \backend\modules\places\models\AeExtMobilefeedbacktoolDepartment[] $aeExtMobilefeedbacktoolDepartments
 * @property \backend\modules\places\models\AeExtMobilefeedbacktoolFundamental[] $aeExtMobilefeedbacktoolFundamentals
 * @property \backend\modules\places\models\AeExtMobilefeedbacktoolTeam[] $aeExtMobilefeedbacktoolTeams
 * @property \backend\modules\places\models\AeExtMobilematching[] $aeExtMobilematchings
 * @property \backend\modules\places\models\AeExtMobileplace[] $aeExtMobileplaces
 * @property \backend\modules\places\models\AeExtMobileproperty[] $aeExtMobileproperties
 * @property \backend\modules\places\models\AeExtMobilepropertyBookmark[] $aeExtMobilepropertyBookmarks
 * @property \backend\modules\places\models\AeExtNotification[] $aeExtNotifications
 * @property \backend\modules\places\models\AeExtProduct[] $aeExtProducts
 * @property \backend\modules\places\models\AeExtProductsCategory[] $aeExtProductsCategories
 * @property \backend\modules\places\models\AeExtProductsTag[] $aeExtProductsTags
 * @property \backend\modules\places\models\AeExtTattoo[] $aeExtTattoos
 * @property \backend\modules\places\models\AeFilename[] $aeFilenames
 * @property \backend\modules\places\models\AeCategory $category
 * @property \backend\modules\places\models\UsergroupsUser $user
 * @property \backend\modules\places\models\AeGameBadge[] $aeGameBadges
 * @property \backend\modules\places\models\AeGameBadge[] $aeGameBadges0
 * @property \backend\modules\places\models\AeGameBranch[] $aeGameBranches
 * @property \backend\modules\places\models\AeGameKeyvaluestorage[] $aeGameKeyvaluestorages
 * @property \backend\modules\places\models\AeGamePlay[] $aeGamePlays
 * @property \backend\modules\places\models\AeGameRole[] $aeGameRoles
 * @property \backend\modules\places\models\AeGameScore[] $aeGameScores
 * @property \backend\modules\places\models\AeGameVariable[] $aeGameVariables
 * @property \backend\modules\places\models\AeLocationLog[] $aeLocationLogs
 * @property \backend\modules\places\models\AeMobile $aeMobile
 * @property \backend\modules\places\models\AePurchase[] $aePurchases
...
abstract class AeGame extends \backend\models\CrudBase
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\places\models\AeCategory::className(), 'targetAttribute' => ['category_id' => 'id']],
            [['user_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\places\models\UsergroupsUser::className(), 'targetAttribute' => ['user_id' => 'id']]
        ];
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeApiFilelookup::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeAppMenu::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeChat::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtDealsLog::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtItem::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtItemsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobileevent::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobilefeedbacktool::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobilefeedbacktoolDepartment::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobilefeedbacktoolFundamental::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobilefeedbacktoolTeam::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobilematching::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobileplace::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobileproperty::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtMobilepropertyBookmark::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtNotification::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtProduct::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtProductsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtProductsTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeExtTattoo::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeFilename::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\places\models\AeCategory::className(), ['id' => 'category_id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\places\models\UsergroupsUser::className(), ['id' => 'user_id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeGameBadge::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeGameBranch::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeGameKeyvaluestorage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeGamePlay::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeGameRole::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeGameScore::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeGameVariable::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AeLocationLog::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\places\models\AeMobile::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\places\models\AePurchase::className(), ['game_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\places\models\query\AeGameQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\places\models\query\AeGameQuery(get_called_class());
    }
