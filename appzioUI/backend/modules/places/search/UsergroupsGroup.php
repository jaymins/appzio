...
use backend\modules\places\models\UsergroupsGroup as UsergroupsGroupModel;

/**
* UsergroupsGroup represents the model behind the search form about `backend\modules\places\models\UsergroupsGroup`.
*/
