...
<div class="giiant-crud usergroups-user-view">
    ...
    <?php $this->beginBlock('backend\modules\places\models\UsergroupsUser'); ?>
...
[
    ...
    'value' => ($model->getGroup()->one() ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/places/usergroups-group/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getGroup()->one()->id, ['/places/usergroups-group/view', 'id' => $model->getGroup()->one()->id,]).' '.
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params[0] = '/places/ae-game' . '/' . $action;
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getCategory()->one()) {
            return Html::a($rel->name, ['/places/ae-category/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\places\models\UsergroupsUser'],
    'active'  => true,
],
[
