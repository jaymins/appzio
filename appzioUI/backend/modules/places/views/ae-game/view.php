...
<div class="giiant-crud ae-game-view">
    ...
    <?php $this->beginBlock('backend\modules\places\models\AeGame'); ?>
...
[
    ...
    'value' => ($model->getUser()->one() ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/places/usergroups-user/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getUser()->one()->id, ['/places/usergroups-user/view', 'id' => $model->getUser()->one()->id,]).' '.
...
[
    ...
    'value' => ($model->getCategory()->one() ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/places/ae-category/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getCategory()->one()->name, ['/places/ae-category/view', 'id' => $model->getCategory()->one()->id,]).' '.
...
<?php $this->beginBlock('AeExtMobileplaces'); ?>
<div style='position: relative'>
<div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            '<span class="glyphicon glyphicon-list"></span> ' . Yii::t('backend', 'List All') . ' Ae Ext Mobileplaces',
            ['/places/ae-ext-mobileplace/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('backend', 'New') . ' Ae Ext Mobileplace',
            ['/places/ae-ext-mobileplace/create', 'AeExtMobileplace' => ['game_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
<?php Pjax::begin(['id'=>'pjax-AeExtMobileplaces', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-AeExtMobileplaces ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?=
 '<div class="table-responsive">'
 . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
    'dataProvider' => new \yii\data\ActiveDataProvider([
        'query' => $model->getAeExtMobileplaces(),
        'pagination' => [
            'pageSize' => 20,
            'pageParam'=>'page-aeextmobileplaces',
        ]
    ]),
    'pager'        => [
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params[0] = '/places/ae-ext-mobileplace' . '/' . $action;
        $params['AeExtMobileplace'] = ['game_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
        
    ],
    'controller' => '/places/ae-ext-mobileplace'
],
        'id',
        'lat',
        'lon',
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\places\models\AeGame'],
    'active'  => true,
],
[
    'content' => $this->blocks['AeExtMobileplaces'],
    'label'   => '<small>Ae Ext Mobileplaces <span class="badge badge-default">'.count($model->getAeExtMobileplaces()->asArray()->all()).'</span></small>',
    'active'  => false,
],
 ]
                 ]
