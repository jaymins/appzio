...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\places\search\AeGame $searchModel
*/
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Mobileplace'),
            ],
                                [
                'url' => ['/places/ae-category/index'],
