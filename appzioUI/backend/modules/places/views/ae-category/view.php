...
<div class="giiant-crud ae-category-view">
    ...
    <?php $this->beginBlock('backend\modules\places\models\AeCategory'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/places/ae-game/create', 'AeGame' => ['category_id' => $model->id]],
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getUser()->one()) {
            return Html::a($rel->id, ['/places/usergroups-user/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\places\models\AeCategory'],
    'active'  => true,
],
[
