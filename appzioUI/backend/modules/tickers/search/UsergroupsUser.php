...
use backend\modules\tickers\models\UsergroupsUser as UsergroupsUserModel;

/**
* UsergroupsUser represents the model behind the search form about `backend\modules\tickers\models\UsergroupsUser`.
*/
