...
use backend\modules\tickers\models\AeGamePlay as AeGamePlayModel;

/**
* AeGamePlay represents the model behind the search form about `backend\modules\tickers\models\AeGamePlay`.
*/
