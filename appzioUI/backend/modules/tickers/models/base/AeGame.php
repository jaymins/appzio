 ...
 *
 * @property \backend\modules\tickers\models\AeApiFilelookup[] $aeApiFilelookups
 * @property \backend\modules\tickers\models\AeAppMenu[] $aeAppMenus
 * @property \backend\modules\tickers\models\AeChat[] $aeChats
 * @property \backend\modules\tickers\models\AeExtArticle[] $aeExtArticles
 * @property \backend\modules\tickers\models\AeExtArticleCategory[] $aeExtArticleCategories
 * @property \backend\modules\tickers\models\AeExtArticleTag[] $aeExtArticleTags
 * @property \backend\modules\tickers\models\AeExtDealsLog[] $aeExtDealsLogs
 * @property \backend\modules\tickers\models\AeExtItem[] $aeExtItems
 * @property \backend\modules\tickers\models\AeExtItemsCategory[] $aeExtItemsCategories
 ...
 * @property \backend\modules\tickers\models\AeExtMobilefeedbacktoolDepartment[] $aeExtMobilefeedbacktoolDepartments
 * @property \backend\modules\tickers\models\AeExtMobilefeedbacktoolFundamental[] $aeExtMobilefeedbacktoolFundamentals
 ...
 * @property \backend\modules\tickers\models\AeExtMobileplace[] $aeExtMobileplaces
 ...
 * @property \backend\modules\tickers\models\AeExtProductsCategory[] $aeExtProductsCategories
 * @property \backend\modules\tickers\models\AeExtProductsTag[] $aeExtProductsTags
 * @property \backend\modules\tickers\models\AeExtTattoo[] $aeExtTattoos
 * @property \backend\modules\tickers\models\AeFilename[] $aeFilenames
 * @property \backend\modules\tickers\models\AeCategory $category
 * @property \backend\modules\tickers\models\UsergroupsUser $user
 * @property \backend\modules\tickers\models\AeGameBadge[] $aeGameBadges
 * @property \backend\modules\tickers\models\AeGameBadge[] $aeGameBadges0
 * @property \backend\modules\tickers\models\AeGameBranch[] $aeGameBranches
 * @property \backend\modules\tickers\models\AeGameKeyvaluestorage[] $aeGameKeyvaluestorages
 * @property \backend\modules\tickers\models\AeGamePlay[] $aeGamePlays
 * @property \backend\modules\tickers\models\AeGameRole[] $aeGameRoles
 * @property \backend\modules\tickers\models\AeGameScore[] $aeGameScores
 * @property \backend\modules\tickers\models\AeGameVariable[] $aeGameVariables
 * @property \backend\modules\tickers\models\AeLocationLog[] $aeLocationLogs
 * @property \backend\modules\tickers\models\AeMobile $aeMobile
 * @property \backend\modules\tickers\models\AePackage[] $aePackages
 * @property \backend\modules\tickers\models\AePackagesTheme[] $aePackagesThemes
...
abstract class AeGame extends \backend\models\CrudBase
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\tickers\models\AeCategory::className(), 'targetAttribute' => ['category_id' => 'id']],
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeApiFilelookup::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeAppMenu::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeChat::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtArticle::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtArticleCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtArticleTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtDealsLog::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtItem::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtItemsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobileevent::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobilefeedbacktool::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobilefeedbacktoolDepartment::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobilefeedbacktoolFundamental::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobilefeedbacktoolTeam::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobilematching::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobileplace::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobileproperty::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtMobilepropertyBookmark::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtNotification::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtProduct::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtProductsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtProductsTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeExtTattoo::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeFilename::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\tickers\models\AeCategory::className(), ['id' => 'category_id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeGameBadge::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeGameBranch::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeGameKeyvaluestorage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeGamePlay::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeGameRole::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeGameScore::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeGameVariable::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AeLocationLog::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\tickers\models\AeMobile::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AePackage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AePackagesTheme::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\tickers\models\AePurchase::className(), ['game_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\tickers\models\query\AeGameQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\tickers\models\query\AeGameQuery(get_called_class());
    }
