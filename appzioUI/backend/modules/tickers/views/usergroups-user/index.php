...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tickers\search\UsergroupsUser $searchModel
*/
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Game Play'),
                                ...
                                [
                'url' => ['/tickers/usergroups-group/index'],
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getGroup()->one()) {
			            return Html::a($rel->id, ['/tickers/usergroups-group/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
