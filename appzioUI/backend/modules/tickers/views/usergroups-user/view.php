...
<div class="giiant-crud usergroups-user-view">
    ...
    <?php $this->beginBlock('backend\modules\tickers\models\UsergroupsUser'); ?>
...
[
    'format' => 'html',
    'attribute' => 'group_id',
    'value' => ($model->getGroup()->one() ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/tickers/usergroups-group/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getGroup()->one()->id, ['/tickers/usergroups-group/view', 'id' => $model->getGroup()->one()->id,]).' '.
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params[0] = '/tickers/ae-game' . '/' . $action;
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/tickers/ae-game-play/create', 'AeGamePlay' => ['user_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getGame()->one()) {
            return Html::a($rel->name, ['/tickers/ae-game/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\tickers\models\UsergroupsUser'],
    'active'  => true,
],
[
