 ...
 * @var backend\modules\tickers\search\AeExtTickerDaily $searchModel
 */
...
?>
<div class="giiant-crud ae-ext-ticker-daily-index">
                    ...
                    'dropdown' => [
                        ...
                        'items' => [
                            [
                                ...
                                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Ext Ticker'),
                            ],
