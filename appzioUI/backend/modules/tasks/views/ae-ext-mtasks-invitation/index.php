...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tasks\search\AeExtMtasksInvitation $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Mtasks Invitations');
...
?>
<div class="giiant-crud ae-ext-mtasks-invitation-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Mtasks Invitations') ?>
        <small>
            List
        </small>
    </h1>
