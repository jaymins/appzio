...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\tasks\search\AeExtMtask $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Mtasks');
...
?>
<div class="giiant-crud ae-ext-mtask-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [
            [
                'url' => ['/tasks/ae-ext-mtasks-proof/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Mtasks Proof'),
            ],
