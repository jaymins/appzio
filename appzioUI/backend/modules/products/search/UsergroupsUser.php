...
use backend\modules\products\models\UsergroupsUser as UsergroupsUserModel;

/**
* UsergroupsUser represents the model behind the search form about `backend\modules\products\models\UsergroupsUser`.
*/
