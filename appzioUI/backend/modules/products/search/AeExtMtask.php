...
use backend\modules\products\models\AeExtMtask as AeExtMtaskModel;

/**
* AeExtMtask represents the model behind the search form about `backend\modules\products\models\AeExtMtask`.
*/
...
[['id', 'owner_id', 'invitation_id', 'assignee_id', 'category_id', 'created_time', 'start_time', 'deadline', 'repeat_frequency', 'times_frequency', 'completion'], 'integer'],
            [['category_name', 'title', 'description', 'picture', 'status', 'comments'], 'safe'],
];
}
