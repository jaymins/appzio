...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\products\search\AeGamePlay $searchModel
*/

$this->title = Yii::t('backend', 'Ae Game Plays');
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Products Cart'),
                                ...
                                [
                'url' => ['/products/ae-ext-products-review/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Products Review'),
            ],
                                [
                'url' => ['/products/ae-game-role/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Game Role'),
            ],
                                [
