...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\products\search\AeExtProductsBookmark $searchModel
*/

$this->title = Yii::t('backend', 'Products Bookmarks');
...
?>
<div class="giiant-crud ae-ext-products-bookmark-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Products Bookmarks') ?>
        <small>
            List
        </small>
    </h1>
