...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\products\search\AeExtProductsCart $searchModel
*/

$this->title = Yii::t('backend', 'Products Carts');
...
?>
<div class="giiant-crud ae-ext-products-cart-index">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Ext Product'),
                                ...
                                [
                'url' => ['/products/ae-ext-mtask/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Ext Mtask'),
            ],
