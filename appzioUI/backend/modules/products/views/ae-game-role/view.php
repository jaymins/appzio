...
<div class="giiant-crud ae-game-role-view">
    ...
    <?php $this->beginBlock('backend\modules\products\models\AeGameRole'); ?>
...
[
    ...
    'value' => ($model->getGame()->one() ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'AeGameRole'=>['game_id' => $model->game_id]])
        : 
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/products/ae-game-play/create', 'AeGamePlay' => ['role_id' => $model->id]],
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\products\models\AeGameRole'],
    'active'  => true,
],
[
