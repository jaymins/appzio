...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\products\search\AeExtProductsReview $searchModel
*/

$this->title = Yii::t('backend', 'Products Reviews');
...
?>
<div class="giiant-crud ae-ext-products-review-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Products Reviews') ?>
        <small>
            List
        </small>
    </h1>
