...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\products\search\AeExtProductsCategory $searchModel
*/

$this->title = Yii::t('backend', 'Products Categories');
...
?>
<div class="giiant-crud ae-ext-products-category-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Products Categories') ?>
        <small>
            List
        </small>
    </h1>
