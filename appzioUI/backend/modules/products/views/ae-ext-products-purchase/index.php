...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\products\search\AeExtProductsPurchase $searchModel
*/

$this->title = Yii::t('backend', 'Products Purchases');
...
?>
<div class="giiant-crud ae-ext-products-purchase-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Products Purchases') ?>
        <small>
            List
        </small>
    </h1>
