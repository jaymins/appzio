...
use backend\modules\items\models\UsergroupsUser as UsergroupsUserModel;

/**
* UsergroupsUser represents the model behind the search form about `backend\modules\items\models\UsergroupsUser`.
*/
