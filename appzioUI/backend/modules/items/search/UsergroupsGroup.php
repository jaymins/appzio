...
use backend\modules\items\models\UsergroupsGroup as UsergroupsGroupModel;

/**
* UsergroupsGroup represents the model behind the search form about `backend\modules\items\models\UsergroupsGroup`.
*/
