...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\items\search\AeExtItemsCategoryItem $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Items Category Items');
...
?>
<div class="giiant-crud ae-ext-items-category-item-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Items Category Items') ?>
        <small>
            List
        </small>
    </h1>
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Item'),
            ],
                                [
