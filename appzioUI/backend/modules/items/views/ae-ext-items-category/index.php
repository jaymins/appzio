...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\items\search\AeExtItemsCategory $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Items Categories');
...
?>
<div class="giiant-crud ae-ext-items-category-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Items Categories') ?>
        <small>
            List
        </small>
    </h1>
