...
<div class="giiant-crud ae-game-view">
    ...
    <?php $this->beginBlock('backend\modules\items\models\AeGame'); ?>
...
[
    ...
    'value' => ($model->category ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/items/ae-category/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->category->name, ['/items/ae-category/view', 'id' => $model->category->id,]).' '.
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/items/ae-ext-item/create', 'AeExtItem' => ['game_id' => $model->id]],
...
<div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            ...
            ['/items/ae-ext-items-category/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('backend', 'New') . ' Ae Ext Items Category',
            ['/items/ae-ext-items-category/create', 'AeExtItemsCategory' => ['app_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
<?php Pjax::begin(['id'=>'pjax-AeExtItemsCategories', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-AeExtItemsCategories ul.pagination a, th a']) ?>
<?=
 '<div class="table-responsive">'
 . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        // using the column name as key, not mapping to 'id' like the standard generator
        $params = is_array($key) ? $key : [$model->primaryKey()[0] => (string) $key];
        $params[0] = '/items/ae-ext-items-category' . '/' . $action;
    ...
    'controller' => '/items/ae-ext-items-category'
],
        'id',
        'parent_id',
        'picture',
...
<div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            ...
            ['/items/ae-game-play/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('backend', 'New') . ' Ae Game Play',
            ['/items/ae-game-play/create', 'AeGamePlay' => ['game_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        // using the column name as key, not mapping to 'id' like the standard generator
        $params = is_array($key) ? $key : [$model->primaryKey()[0] => (string) $key];
        $params[0] = '/items/ae-game-play' . '/' . $action;
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\items\models\AeGame'],
    'active'  => true,
],
[
...
[
    ...
    'label'   => '<small>Ae Ext Items Categories <span class="badge badge-default">'. $model->getAeExtItemsCategories()->count() . '</span></small>',
    'active'  => false,
],
[
