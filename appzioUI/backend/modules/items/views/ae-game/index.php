...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\items\search\AeGame $searchModel
*/
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [
            [
                'url' => ['/items/ae-ext-item/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Item'),
            ],
                                [
        ...
        'columns' => [
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->user) {
			            return Html::a($rel->id, ['/items/usergroups-user/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->category) {
			            return Html::a($rel->name, ['/items/ae-category/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
