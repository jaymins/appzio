...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\items\search\UsergroupsUser $searchModel
*/
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Game Play'),
                                ...
                                [
                'url' => ['/items/usergroups-group/index'],
        ...
        'columns' => [
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->group) {
			            return Html::a($rel->id, ['/items/usergroups-group/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
