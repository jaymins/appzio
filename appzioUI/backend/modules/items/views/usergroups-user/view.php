...
<div class="giiant-crud usergroups-user-view">
    ...
    <?php $this->beginBlock('backend\modules\items\models\UsergroupsUser'); ?>
...
[
    ...
    'attribute' => 'group_id',
    'value' => ($model->group ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/items/usergroups-group/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->group->id, ['/items/usergroups-group/view', 'id' => $model->group->id,]).' '.
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/items/ae-game/create', 'AeGame' => ['user_id' => $model->id]],
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/items/ae-game-play/create', 'AeGamePlay' => ['user_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\items\models\UsergroupsUser'],
    'active'  => true,
],
[
