 ...
 *
 * @property \backend\modules\items\models\AeApiFilelookup[] $aeApiFilelookups
 * @property \backend\modules\items\models\AeAppMenu[] $aeAppMenus
 * @property \backend\modules\items\models\AeChat[] $aeChats
 * @property \backend\modules\items\models\AeExtArticle[] $aeExtArticles
 * @property \backend\modules\items\models\AeExtArticleCategory[] $aeExtArticleCategories
 * @property \backend\modules\items\models\AeExtArticleTag[] $aeExtArticleTags
 * @property \backend\modules\items\models\AeExtArticleTemplate[] $aeExtArticleTemplates
 * @property \backend\modules\items\models\AeExtDealsLog[] $aeExtDealsLogs
 * @property \backend\modules\items\models\AeExtItem[] $aeExtItems
 * @property \backend\modules\items\models\AeExtItemsCategory[] $aeExtItemsCategories
 ...
 * @property \backend\modules\items\models\AeExtMobilefeedbacktoolDepartment[] $aeExtMobilefeedbacktoolDepartments
 * @property \backend\modules\items\models\AeExtMobilefeedbacktoolFundamental[] $aeExtMobilefeedbacktoolFundamentals
 ...
 * @property \backend\modules\items\models\AeExtMobileplace[] $aeExtMobileplaces
 ...
 * @property \backend\modules\items\models\AeExtProductsCategory[] $aeExtProductsCategories
 * @property \backend\modules\items\models\AeExtProductsTag[] $aeExtProductsTags
 * @property \backend\modules\items\models\AeExtQuiz[] $aeExtQuizzes
 * @property \backend\modules\items\models\AeExtQuizQuestion[] $aeExtQuizQuestions
 * @property \backend\modules\items\models\AeExtQuizSet[] $aeExtQuizSets
 * @property \backend\modules\items\models\AeExtTattoo[] $aeExtTattoos
 * @property \backend\modules\items\models\AeFilename[] $aeFilenames
 * @property \backend\modules\items\models\AeCategory $category
 * @property \backend\modules\items\models\UsergroupsUser $user
 * @property \backend\modules\items\models\AeGameBadge[] $aeGameBadges
 * @property \backend\modules\items\models\AeGameBadge[] $aeGameBadges0
 * @property \backend\modules\items\models\AeGameBranch[] $aeGameBranches
 * @property \backend\modules\items\models\AeGameKeyvaluestorage[] $aeGameKeyvaluestorages
 * @property \backend\modules\items\models\AeGamePlay[] $aeGamePlays
 * @property \backend\modules\items\models\AeGameRole[] $aeGameRoles
 * @property \backend\modules\items\models\AeGameScore[] $aeGameScores
 * @property \backend\modules\items\models\AeGameVariable[] $aeGameVariables
 * @property \backend\modules\items\models\AeLocationLog[] $aeLocationLogs
 * @property \backend\modules\items\models\AeMobile $aeMobile
 * @property \backend\modules\items\models\AePackage[] $aePackages
 * @property \backend\modules\items\models\AePackagesTheme[] $aePackagesThemes
...
abstract class AeGame extends \backend\models\CrudBase
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\items\models\AeCategory::className(), 'targetAttribute' => ['category_id' => 'id']],
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeApiFilelookup::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeAppMenu::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeChat::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtArticle::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtArticleCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtArticleTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtArticleTemplate::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtDealsLog::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtItem::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtItemsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobileevent::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobilefeedbacktool::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobilefeedbacktoolDepartment::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobilefeedbacktoolFundamental::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobilefeedbacktoolTeam::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobilematching::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobileplace::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobileproperty::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtMobilepropertyBookmark::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtNotification::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtProduct::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtProductsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtProductsTag::className(), ['app_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getAeExtQuizzes()
    {
        return $this->hasMany(\backend\modules\items\models\AeExtQuiz::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtQuizQuestion::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtQuizSet::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeExtTattoo::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeFilename::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\items\models\AeCategory::className(), ['id' => 'category_id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeGameBadge::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeGameBranch::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeGameKeyvaluestorage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeGamePlay::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeGameRole::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeGameScore::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeGameVariable::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AeLocationLog::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\items\models\AeMobile::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AePackage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AePackagesTheme::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\items\models\AePurchase::className(), ['game_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\items\models\query\AeGameQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\items\models\query\AeGameQuery(get_called_class());
    }
