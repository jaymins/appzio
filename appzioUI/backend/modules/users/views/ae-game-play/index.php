...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\users\search\AeGamePlay $searchModel
*/
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Game'),
                                ...
                                [
                'url' => ['/users/usergroups-user/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Usergroups User'),
            ],
                                [
                'url' => ['/users/ae-role/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Role'),
            ],
