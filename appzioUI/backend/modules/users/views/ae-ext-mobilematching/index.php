...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\users\search\AeExtMobilematching $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Mobilematchings');
...
?>
<div class="giiant-crud ae-ext-mobilematching-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Mobilematchings') ?>
        <small>
            List
        </small>
    </h1>
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getPlay()->one()) {
			            return Html::a($rel->id, ['/users/ae-game-play/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
