...
<div class="giiant-crud ae-game-view">
    ...
    <?php $this->beginBlock('backend\modules\users\models\AeGame'); ?>
...
[
    ...
    'value' => ($model->getCategory()->one() ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/users/ae-category/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getCategory()->one()->name, ['/users/ae-category/view', 'id' => $model->getCategory()->one()->id,]).' '.
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/users/ae-game-play/create', 'AeGamePlay' => ['game_id' => $model->id]],
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getUser()->one()) {
            return Html::a($rel->id, ['/users/usergroups-user/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\users\models\AeGame'],
    'active'  => true,
],
[
