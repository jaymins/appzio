...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\users\search\AeGamePlayVariable $searchModel
*/

$this->title = Yii::t('backend', 'Ae Game Play Variables');
...
?>
<div class="giiant-crud ae-game-play-variable-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Game Play Variables') ?>
        <small>
            List
        </small>
    </h1>
