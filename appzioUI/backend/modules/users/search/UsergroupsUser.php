...
use backend\modules\users\models\UsergroupsUser as UsergroupsUserModel;

/**
 * UsergroupsUser represents the model behind the search form about `backend\modules\users\models\UsergroupsUser`.
 */
