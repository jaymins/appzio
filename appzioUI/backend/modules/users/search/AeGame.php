...
use backend\modules\users\models\AeGame as AeGameModel;

/**
* AeGame represents the model behind the search form about `backend\modules\users\models\AeGame`.
*/
