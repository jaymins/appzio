...
use backend\modules\fitness\models\AeExtArticle as AeExtArticleModel;

/**
* AeExtArticle represents the model behind the search form about `backend\modules\fitness\models\AeExtArticle`.
*/
