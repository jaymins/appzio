...
use backend\modules\fitness\models\AeGame as AeGameModel;

/**
* AeGame represents the model behind the search form about `backend\modules\fitness\models\AeGame`.
*/
