...
use backend\modules\fitness\models\UsergroupsUser as UsergroupsUserModel;

/**
* UsergroupsUser represents the model behind the search form about `backend\modules\fitness\models\UsergroupsUser`.
*/
