...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtFoodRecipeStep $searchModel
*/

$this->title = Yii::t('backend', 'Recipe Steps');
...
?>
<div class="giiant-crud ae-ext-food-recipe-step-index">
