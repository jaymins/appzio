...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtFitProgramCategory $searchModel
*/

$this->title = Yii::t('backend', 'Program Categories');
...
?>
<div class="giiant-crud ae-ext-fit-program-category-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Program Categories') ?>
        <small>
            List
        </small>
    </h1>
