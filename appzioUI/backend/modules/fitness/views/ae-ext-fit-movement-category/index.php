...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtFitMovementCategory $searchModel
*/

$this->title = Yii::t('backend', 'Components');
...
?>
<div class="giiant-crud ae-ext-fit-movement-category-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <!--<div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Associated Exercises'),
            ],
