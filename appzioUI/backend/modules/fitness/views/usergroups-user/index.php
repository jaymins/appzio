...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\UsergroupsUser $searchModel
*/
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Game Play'),
                                ...
                                [
                'url' => ['/fitness/usergroups-group/index'],
        ...
        'columns' => [
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->group) {
			            return Html::a($rel->id, ['/fitness/usergroups-group/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
