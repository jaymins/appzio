...
<div class="giiant-crud usergroups-user-view">
    ...
    <?php $this->beginBlock('backend\modules\fitness\models\UsergroupsUser'); ?>
...
[
    ...
    'attribute' => 'group_id',
    'value' => ($model->group ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/fitness/usergroups-group/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->group->id, ['/fitness/usergroups-group/view', 'id' => $model->group->id,]).' '.
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params[0] = '/fitness/ae-game' . '/' . $action;
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/fitness/ae-game-play/create', 'AeGamePlay' => ['user_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\fitness\models\UsergroupsUser'],
    'active'  => true,
],
[
