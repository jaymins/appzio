...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtFitComponent $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Fit Components');
...
?>
<div class="giiant-crud ae-ext-fit-component-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Fit Components') ?>
        <small>
            List
        </small>
    </h1>
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [
            [
                'url' => ['/fitness/ae-ext-fit-component-movement/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Fit Component Movement'),
            ],
                                [
