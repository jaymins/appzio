...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtArticleCategory $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Article Categories');
...
?>
<div class="giiant-crud ae-ext-article-category-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Article Categories') ?>
        <small>
            List
        </small>
    </h1>
