...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtFitProgramSubcategory $searchModel
*/

$this->title = Yii::t('backend', 'Program Subcategories');
...
?>
<div class="giiant-crud ae-ext-fit-program-subcategory-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Program Subcategories') ?>
        <small>
            List
        </small>
    </h1>
