...
?>
<div class="giiant-crud ae-ext-fit-pr-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'AeExtFitPr'=>$copyParams],
    ...
    <?php $this->beginBlock('backend\modules\fitness\models\AeExtFitPr'); ?>
...
[
    ...
    'value' => ($model->app ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'AeExtFitPr'=>['app_id' => $model->app_id]])
        : 
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/fitness/ae-ext-fit-component-movement/create', 'AeExtFitComponentMovement' => ['pr_id' => $model->id]],
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['AeExtFitComponentMovement'] = ['pr_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\fitness\models\AeExtFitPr'],
    'active'  => true,
],
[
