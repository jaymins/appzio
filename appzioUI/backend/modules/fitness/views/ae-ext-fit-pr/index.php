...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtFitPr $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Fit Prs');
...
?>
<div class="giiant-crud ae-ext-fit-pr-index">
