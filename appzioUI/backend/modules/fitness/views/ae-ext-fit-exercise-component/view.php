...
?>
<div class="giiant-crud ae-ext-fit-exercise-component-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'AeExtFitExerciseComponent'=>$copyParams],
    ...
    <?php $this->beginBlock('backend\modules\fitness\models\AeExtFitExerciseComponent'); ?>
...
[
    ...
    'value' => ($model->exercise ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'AeExtFitExerciseComponent'=>['exercise_id' => $model->exercise_id]])
        : 
...
[
    ...
    'value' => ($model->component ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'AeExtFitExerciseComponent'=>['component_id' => $model->component_id]])
        : 
        '<span class="label label-warning">?</span>'),
],
    ],
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\fitness\models\AeExtFitExerciseComponent'],
    'active'  => true,
],
 ]
                 ]
