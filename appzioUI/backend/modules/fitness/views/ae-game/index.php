...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeGame $searchModel
*/
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Article'),
            ],
                                [
                'url' => ['/fitness/ae-ext-article-category/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Ae Ext Article Category'),
            ],
                                [
                'url' => ['/fitness/ae-category/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Category'),
            ],
                                [
                'url' => ['/fitness/usergroups-user/index'],
        ...
        'columns' => [
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->user) {
			            return Html::a($rel->id, ['/fitness/usergroups-user/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->category) {
			            return Html::a($rel->name, ['/fitness/ae-category/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
