...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtFoodRecipeType $searchModel
*/

$this->title = Yii::t('backend', 'Recipe Types');
...
?>
<div class="giiant-crud ae-ext-food-recipe-type-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Food Recipe'),
            ],
                                [
