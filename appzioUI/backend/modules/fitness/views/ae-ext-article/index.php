...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtArticle $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Articles');
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Game'),
                                ...
                                [
                'url' => ['/fitness/ae-ext-article-category/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Ext Article Category'),
            ],
                                [
                'url' => ['/fitness/ae-ext-fit-exercise/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Workout'),
            ],
                                [
                'url' => ['/fitness/ae-ext-fit-movement/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Movement'),
            ],
                                [
                'url' => ['/fitness/ae-ext-fit-program/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Program'),
            ],
