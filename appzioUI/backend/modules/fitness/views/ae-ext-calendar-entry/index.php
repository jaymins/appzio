...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\fitness\search\AeExtCalendarEntry $searchModel
*/

$this->title = Yii::t('backend', 'Ae Ext Calendar Entries');
...
?>
<div class="giiant-crud ae-ext-calendar-entry-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <h1>
        <?= Yii::t('backend', 'Ae Ext Calendar Entries') ?>
        <small>
            List
        </small>
    </h1>
        ...
        <div class="pull-right">
            ...
            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Game Play'),
                                ...
                                [
                'url' => ['/fitness/ae-ext-food-recipe/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Ext Food Recipe'),
            ],
                                [
                'url' => ['/fitness/ae-ext-fit-exercise/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Workout'),
            ],
                                [
                'url' => ['/fitness/ae-ext-fit-program/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('backend', 'Ae Ext Fit Program'),
            ],
                                [
