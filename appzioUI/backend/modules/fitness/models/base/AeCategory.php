...
abstract class AeCategory extends \backend\models\CrudBase
{
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeGame::className(), ['category_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\fitness\models\query\AeCategoryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\fitness\models\query\AeCategoryQuery(get_called_class());
    }
