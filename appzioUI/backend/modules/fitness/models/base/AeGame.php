 ...
 *
 * @property \backend\modules\fitness\models\AeApiFilelookup[] $aeApiFilelookups
 * @property \backend\modules\fitness\models\AeAppMenu[] $aeAppMenus
 * @property \backend\modules\fitness\models\AeChat[] $aeChats
 * @property \backend\modules\fitness\models\AeExtArticle[] $aeExtArticles
 * @property \backend\modules\fitness\models\AeExtArticleCategory[] $aeExtArticleCategories
 * @property \backend\modules\fitness\models\AeExtArticleTag[] $aeExtArticleTags
 * @property \backend\modules\fitness\models\AeExtArticleTemplate[] $aeExtArticleTemplates
 * @property \backend\modules\fitness\models\AeExtDealsLog[] $aeExtDealsLogs
 * @property \backend\modules\fitness\models\AeExtItem[] $aeExtItems
 * @property \backend\modules\fitness\models\AeExtItemsCategory[] $aeExtItemsCategories
 ...
 * @property \backend\modules\fitness\models\AeExtMobilefeedbacktoolDepartment[] $aeExtMobilefeedbacktoolDepartments
 * @property \backend\modules\fitness\models\AeExtMobilefeedbacktoolFundamental[] $aeExtMobilefeedbacktoolFundamentals
 ...
 * @property \backend\modules\fitness\models\AeExtMobileplace[] $aeExtMobileplaces
 ...
 * @property \backend\modules\fitness\models\AeExtProductsCategory[] $aeExtProductsCategories
 * @property \backend\modules\fitness\models\AeExtProductsTag[] $aeExtProductsTags
 * @property \backend\modules\fitness\models\AeExtQuiz[] $aeExtQuizzes
 * @property \backend\modules\fitness\models\AeExtQuizQuestion[] $aeExtQuizQuestions
 * @property \backend\modules\fitness\models\AeExtQuizSet[] $aeExtQuizSets
 * @property \backend\modules\fitness\models\AeExtTattoo[] $aeExtTattoos
 * @property \backend\modules\fitness\models\AeFilename[] $aeFilenames
 * @property \backend\modules\fitness\models\AeCategory $category
 * @property \backend\modules\fitness\models\UsergroupsUser $user
 * @property \backend\modules\fitness\models\AeGameBadge[] $aeGameBadges
 * @property \backend\modules\fitness\models\AeGameBadge[] $aeGameBadges0
 * @property \backend\modules\fitness\models\AeGameBranch[] $aeGameBranches
 * @property \backend\modules\fitness\models\AeGameKeyvaluestorage[] $aeGameKeyvaluestorages
 * @property \backend\modules\fitness\models\AeGamePlay[] $aeGamePlays
 * @property \backend\modules\fitness\models\AeGameRole[] $aeGameRoles
 * @property \backend\modules\fitness\models\AeGameScore[] $aeGameScores
 * @property \backend\modules\fitness\models\AeGameVariable[] $aeGameVariables
 * @property \backend\modules\fitness\models\AeLocationLog[] $aeLocationLogs
 * @property \backend\modules\fitness\models\AeMobile $aeMobile
 * @property \backend\modules\fitness\models\AePackage[] $aePackages
 * @property \backend\modules\fitness\models\AePackagesTheme[] $aePackagesThemes
...
abstract class AeGame extends \backend\models\CrudBase
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\fitness\models\AeCategory::className(), 'targetAttribute' => ['category_id' => 'id']],
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeApiFilelookup::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeAppMenu::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeChat::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtArticle::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtArticleCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtArticleTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtArticleTemplate::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtDealsLog::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtItem::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtItemsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobileevent::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobilefeedbacktool::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobilefeedbacktoolDepartment::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobilefeedbacktoolFundamental::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobilefeedbacktoolTeam::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobilematching::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobileplace::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobileproperty::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtMobilepropertyBookmark::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtNotification::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtProduct::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtProductsCategory::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtProductsTag::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtQuiz::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtQuizQuestion::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtQuizSet::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeExtTattoo::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeFilename::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\fitness\models\AeCategory::className(), ['id' => 'category_id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeGameBadge::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeGameBranch::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeGameKeyvaluestorage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeGamePlay::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeGameRole::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeGameScore::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeGameVariable::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AeLocationLog::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\fitness\models\AeMobile::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AePackage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AePackagesTheme::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\fitness\models\AePurchase::className(), ['game_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\fitness\models\query\AeGameQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\fitness\models\query\AeGameQuery(get_called_class());
    }
