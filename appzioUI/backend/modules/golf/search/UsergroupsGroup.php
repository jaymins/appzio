...
use backend\modules\golf\models\UsergroupsGroup as UsergroupsGroupModel;

/**
* UsergroupsGroup represents the model behind the search form about `backend\modules\golf\models\UsergroupsGroup`.
*/
