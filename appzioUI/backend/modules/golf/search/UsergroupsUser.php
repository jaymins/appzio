...
use backend\modules\golf\models\UsergroupsUser as UsergroupsUserModel;

/**
* UsergroupsUser represents the model behind the search form about `backend\modules\golf\models\UsergroupsUser`.
*/
