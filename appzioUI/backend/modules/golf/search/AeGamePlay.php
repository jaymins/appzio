...
use backend\modules\golf\models\AeGamePlay as AeGamePlayModel;

/**
* AeGamePlay represents the model behind the search form about `backend\modules\golf\models\AeGamePlay`.
*/
