...
<div class="giiant-crud ae-game-view">
    ...
    <?php $this->beginBlock('backend\modules\golf\models\AeGame'); ?>
...
[
    ...
    'value' => ($model->getCategory()->one() ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['/golf/ae-category/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->getCategory()->one()->name, ['/golf/ae-category/view', 'id' => $model->getCategory()->one()->id,]).' '.
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['/golf/ae-game-play/create', 'AeGamePlay' => ['game_id' => $model->id]],
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\golf\models\AeGame'],
    'active'  => true,
],
[
