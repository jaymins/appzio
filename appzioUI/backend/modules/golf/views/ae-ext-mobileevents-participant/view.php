...
$this->title = Yii::t('backend', 'Ae Ext Mobileevents Participant');
$this->params['breadcrumbs'][] = ['label' => Yii::t('backend', 'Ae Ext Mobileevents Participants'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => (string)$model->id, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = Yii::t('backend', 'View');
?>
<div class="giiant-crud ae-ext-mobileevents-participant-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'AeExtMobileeventsParticipant'=>$copyParams],
    ...
    <?php $this->beginBlock('backend\modules\golf\models\AeExtMobileeventsParticipant'); ?>
 ...
 [
    ...
    'content' => $this->blocks['backend\modules\golf\models\AeExtMobileeventsParticipant'],
    'active'  => true,
],
 ]
                 ]
