...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\golf\search\AeExtMobileeventsParticipant $searchModel
*/
...
?>
<div class="giiant-crud ae-ext-mobileevents-participant-index">
    ...
    <h1>
        <?= Yii::t('backend', 'AeExtMobileeventsParticipants') ?>        <small>
            List
        </small>
    </h1>
