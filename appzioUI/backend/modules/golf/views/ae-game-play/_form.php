...
$form->field($model, 'role_id')->dropDownList(
    \yii\helpers\ArrayHelper::map(backend\modules\golf\models\AeRole::find()->all(), 'id', 'title'),
    [
...
$form->field($model, 'game_id')->dropDownList(
    \yii\helpers\ArrayHelper::map(backend\modules\golf\models\AeGame::find()->all(), 'id', 'name'),
    [
        'prompt' => Yii::t('backend', 'Select'),
