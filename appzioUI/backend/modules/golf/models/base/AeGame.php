 ...
 *
 * @property \backend\modules\golf\models\AeApiFilelookup[] $aeApiFilelookups
 * @property \backend\modules\golf\models\AeAppMenu[] $aeAppMenus
 * @property \backend\modules\golf\models\AeChat[] $aeChats
 * @property \backend\modules\golf\models\AeExtDealsLog[] $aeExtDealsLogs
 * @property \backend\modules\golf\models\AeExtMobilefeedbacktool[] $aeExtMobilefeedbacktools
 * @property \backend\modules\golf\models\AeExtMobilefeedbacktoolDepartment[] $aeExtMobilefeedbacktoolDepartments
 * @property \backend\modules\golf\models\AeExtMobilefeedbacktoolFundamental[] $aeExtMobilefeedbacktoolFundamentals
 ...
 * @property \backend\modules\golf\models\AeFilename[] $aeFilenames
 * @property \backend\modules\golf\models\AeCategory $category
 * @property \backend\modules\golf\models\UsergroupsUser $user
 * @property \backend\modules\golf\models\AeGameBadge[] $aeGameBadges
 * @property \backend\modules\golf\models\AeGameBadge[] $aeGameBadges0
 * @property \backend\modules\golf\models\AeGameBranch[] $aeGameBranches
 * @property \backend\modules\golf\models\AeGameKeyvaluestorage[] $aeGameKeyvaluestorages
...
abstract class AeGame extends \backend\models\CrudBase
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\modules\golf\models\AeCategory::className(), 'targetAttribute' => ['category_id' => 'id']],
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeApiFilelookup::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeAppMenu::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeChat::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeExtDealsLog::className(), ['app_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeExtMobilefeedbacktool::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeExtMobilefeedbacktoolDepartment::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeExtMobilefeedbacktoolFundamental::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeExtMobilefeedbacktoolTeam::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeExtMobilematching::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeExtMobileproperty::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeExtMobilepropertyBookmark::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeFilename::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\backend\modules\golf\models\AeCategory::className(), ['id' => 'category_id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeGameBadge::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeGameBranch::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeGameKeyvaluestorage::className(), ['game_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\modules\golf\models\AeGamePlay::className(), ['game_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\golf\models\query\AeGameQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\golf\models\query\AeGameQuery(get_called_class());
    }
