...
abstract class UsergroupsGroup extends \backend\models\CrudBase
{
    ...
    /**
     * @inheritdoc
     * @return \backend\modules\golf\models\query\UsergroupsGroupQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\golf\models\query\UsergroupsGroupQuery(get_called_class());
    }
