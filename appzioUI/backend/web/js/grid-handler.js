...
(function ($) {
    ...
    $(document).ready(function(){
        ...
        if ( $( '.usergroups-user-index' ).length ) {
            jQuery('#w1').yiiGridView({"filterUrl":"\/dbadmin\/backend\/web\/index.php?r=users\/usergroups-user","filterSelector":"#w1-filters input, #w1-filters select"});
        }
